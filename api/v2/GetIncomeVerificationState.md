...
```json
{
  ...
  "documents": [
    ...
    {
      "documentId": "9354edee-2738-43c6-932e-f3e1f3c4cg0e",
      "documentHash": "c7cc2abed907fd0839707d07365158da3aa51e4a",
      "type": "PAYSLIP",
      "received": "2022-08-11T10:18:20.001",
      "status": "TOO_OLD",
      "usedToDetectIncome": false,
      "sizeBytes": "109493",
      "textExtractionType": "OCR",
      "contentType": "application/pdf"
    }
  ],
  "result": {
    ...
    "analysisResult": {
      "primaryIncome": {
        ...
        "payCycle": 30,
        "docIds": [
          "d3107619-26d9-4093-a7e4-79fd9d4caeb2"
        ]
      }
    }
  }
...
Consider using the [document chase api](DocumentChase.md) to see more details on what documents are still required from the applicant.
...
| SUSPECTED_FRAUD             | This means that one of the document tampering checks failed and the whole case should be reviewed by the fraud team (Automated fraud checks must be enabled). The front end SprintHive console will show Document Status "Potential Doc Tampering" |
| CONFIRMED_FRAUD             | This can happen if the fraud team confirms fraud or if a high risk document tampering check has failed (Automated fraud checks must be enabled). The front end SprintHive console will show Document Status "Confirmed Doc Tampering"              |
